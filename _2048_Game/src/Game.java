...
public class Game extends JPanel implements KeyListener
{
    ...
    public void paint( Graphics g )
    {
        ...
        g2.setColor( new Color(188, 172, 160));
        ...
        if (game.gameOver()) {
            ...
            for (int i = 0; i < 4; i++) {
                g2.setColor(new Color(187, 173, 160));
                g2.fillRoundRect(i * 60 + 150, 0 * 60 + 60, 50, 50, 5, 5);
                g2.fillRoundRect(i * 60 + 150, 3 * 60 + 60, 50, 50, 5, 5);
            }

            String gameText = "GAME";
            for (int i = 0; i < gameText.length(); i++) {
                char letter = gameText.charAt(i);
                g2.setColor(Color.RED);
                g2.fillRoundRect(i * 60 + 150, 1 * 60 + 60, 50, 50, 5, 5);
                g2.setColor(Color.black);
                g.drawString(String.valueOf(letter), i * 60 + 160, 1 * 60 + 75);
            }

            String overText = "OVER";
            for (int i = 0; i < overText.length(); i++) {
                char letter = overText.charAt(i);
                g2.setColor(Color.RED);
                g2.fillRoundRect(i * 60 + 150, 2 * 60 + 60, 50, 50, 5, 5);
                g2.setColor(Color.black);
                g.drawString(String.valueOf(letter), i * 60 + 160, 2 * 60 + 75);
            }
        }
