 ...
 //Represents the 2048 board and provides methods for moving up, down, left and right. and GUI
public class Board
{
    public Tile[][] board;
    int grids = 4;
    ...
    //Compares two tile's values together and if they are the same or if one is equal to 0 (plain tile) - their values are added
    //(provided that the tiles we are comparing are two different tiles and they are moving towards the appropriate direction)
